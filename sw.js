const CACHE='nbl-v1.3.3';
const ASSETS=['./','./index.html','./styles.css','./v13.css','./app.js','./hotfix.js','./sync-v2.js','./brave-fix.js','./youtube-backend.js','./router-core.js','./vivaldi-playlists.js','./vivaldi-launcher.js','./manifest.webmanifest','./icon.svg'];
