const CACHE='nbl-v1.4.1';
const ASSETS=['./','./index.html','./styles.css','./v13.css','./v14.css','./slots-bootstrap.js','./app.js','./hotfix.js','./sync-v2.js','./brave-fix.js','./youtube-backend.js','./router-core.js','./vivaldi-playlists.js','./vivaldi-launcher.js','./slots-ui.js','./shuffle-mode.js','./manifest.webmanifest','./icon.svg'];
