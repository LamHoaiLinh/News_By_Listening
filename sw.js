const CACHE='nbl-v1.3.0';
const ASSETS=['./','./index.html','./styles.css','./v13.css','./app.js','./hotfix.js','./sync-v2.js','./brave-fix.js','./youtube-backend.js','./vivaldi-playlists.js','./manifest.webmanifest','./icon.svg'];
